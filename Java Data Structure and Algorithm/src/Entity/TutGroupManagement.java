 ...
 public void list() {
  ...
  public void filter(Object prefix) {
    ...
    public void generateReport() {
        ...
        System.out.println("Tutorial Group Report:");
        ...
        for (int i = 0; i < numberOfEntries; i++) {
            ...
            System.out.println("ID: " + student.getIdNo() + ", Name: " + student.getName() +
                               ", Entry Date/Time: " + formattedDate);
        }
    }
    ...
    public boolean Change(T studentChange, Object changeTo) {
        if (!(studentChange instanceof Student) || !(changeTo instanceof TutGroupManagement)) {
            System.out.print("Invalid input types.");
            return false;
        }
        ...
        System.out.println("Student not found or unable to change tutorial group.");
        return false;
    }
